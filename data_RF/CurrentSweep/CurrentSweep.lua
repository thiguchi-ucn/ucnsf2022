...
for vals = 1, 20, 1 do
	...
	mi_setblockprop("OxyFreeCopper", 0, 0.05)
	mi_clearselected()
	...
	mi_saveas("M:\\ParticlePhysics\\UCN\\_Users\\dgeorgescu\\CurrentSweep\\" .. Cstring .. "e-1A\\FarShield.FEM")
	mi_createmesh()
	...
	mo_addcontour(0,28)
	mo_selectpoint(0,-28)
	mo_makeplot(2, 560, "M:\\ParticlePhysics\\UCN\\_Users\\dgeorgescu\\CurrentSweep\\" .. Cstring .. "e-1A\\Y=0mmPlotNormal.txt", 0)
	mo_makeplot(3, 560, "M:\\ParticlePhysics\\UCN\\_Users\\dgeorgescu\\CurrentSweep\\" .. Cstring .. "e-1A\\Y=0mmPlotTangent.txt", 0)
	mo_clearcontour()

	mo_getpointvalues(0,-6)
	mo_addcontour(4.25,28)
	mo_selectpoint(4.25,-28)
	mo_makeplot(2, 560, "M:\\ParticlePhysics\\UCN\\_Users\\dgeorgescu\\CurrentSweep\\" .. Cstring .. "e-1A\\Y=42.5mmPlotNormal.txt", 0)
	mo_makeplot(3, 560, "M:\\ParticlePhysics\\UCN\\_Users\\dgeorgescu\\CurrentSweep\\" .. Cstring .. "e-1A\\Y=42.5mmPlotTangent.txt", 0)
	mo_clearcontour()

	mo_showdensityplot(1, 0, 0.000390318120018651, 1.15660153653664e-009, "bmag")
	mo_savebitmap("M:\\ParticlePhysics\\UCN\\_Users\\dgeorgescu\\CurrentSweep\\" .. Cstring .. "e-1A\\ContourMap.jpg")
