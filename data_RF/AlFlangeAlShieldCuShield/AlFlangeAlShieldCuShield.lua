...
for value = 0, 20, 2 do 
	...
	newstr = tostring(value)
	mi_saveas("M:\\ParticlePhysics\\UCN\\_Users\\dgeorgescu\\TakashiSpinFlipperDesign\\FemmSimulations\\AlFlangeAlShieldCuShield\\20mm+" .. newstr .. "mmlength\\FarShield.FEM")
	mi_createmesh()
	...
	mo_addcontour(0,28)
	mo_selectpoint(0,-28)
	mo_makeplot(2, 560, "M:\\ParticlePhysics\\UCN\\_Users\\dgeorgescu\\TakashiSpinFlipperDesign\\FemmSimulations\\AlFlangeAlShieldCuShield\\20mm+" .. newstr .. "mmlength\\Y=0mmPlotNormal.txt", 0)
	mo_makeplot(3, 560, "M:\\ParticlePhysics\\UCN\\_Users\\dgeorgescu\\TakashiSpinFlipperDesign\\FemmSimulations\\AlFlangeAlShieldCuShield\\20mm+" .. newstr .. "mmlength\\Y=0mmPlotTangent.txt", 0)
	mo_clearcontour()

	mo_getpointvalues(0,-6)
	mo_addcontour(4.25,28)
	mo_selectpoint(4.25,-28)
	mo_makeplot(2, 560, "M:\\ParticlePhysics\\UCN\\_Users\\dgeorgescu\\TakashiSpinFlipperDesign\\FemmSimulations\\AlFlangeAlShieldCuShield\\20mm+" .. newstr .. "mmlength\\Y=42.5mmPlotNormal.txt", 0)
	mo_makeplot(3, 560, "M:\\ParticlePhysics\\UCN\\_Users\\dgeorgescu\\TakashiSpinFlipperDesign\\FemmSimulations\\AlFlangeAlShieldCuShield\\20mm+" .. newstr .. "mmlength\\Y=42.5mmPlotTangent.txt", 0)
	mo_clearcontour()

	mo_showdensityplot(1, 0, 0.000390318120018651, 1.15660153653664e-009, "bmag")
	mo_savebitmap("M:\\ParticlePhysics\\UCN\\_Users\\dgeorgescu\\TakashiSpinFlipperDesign\\FemmSimulations\\AlFlangeAlShieldCuShield\\20mm+" .. newstr .. "mmlength\\ContourMap.jpg")
