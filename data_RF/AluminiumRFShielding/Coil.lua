...
for variable = 2,40,2 do
	...
	mi_saveas("C:\\Users\\marta\\Desktop\\Denis Stuff\\3mmThick" .. newstr .. "mmLength\\FarShield.FEM")
	mi_createmesh()
	...
	mo_addcontour(0,28)
	mo_selectpoint(0,-28)
	mo_makeplot(1, 560, "C:\\Users\\marta\\Desktop\\Denis Stuff\\3mmThick" .. newstr .. "mmLength\\Y=0mmPlot.txt", 0)
	mo_clearcontour()
	
	mo_getpointvalues(0,-6)
	mo_addcontour(4.25,28)
	mo_selectpoint(4.25,-28)
	mo_makeplot(1, 560, "C:\\Users\\marta\\Desktop\\Denis Stuff\\3mmThick" .. newstr .. "mmLength\\Y=42.5mmPlot.txt", 0)
	mo_clearcontour()
	
	mo_showdensityplot(1, 0, 0.000390318120018651, 1.15660153653664e-009, "bmag")
	mo_savebitmap("C:\\Users\\marta\\Desktop\\Denis Stuff\\3mmThick" .. newstr .. "mmLength\\ContourMap.jpg")
